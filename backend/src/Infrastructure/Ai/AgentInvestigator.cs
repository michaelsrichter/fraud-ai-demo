...
public sealed class AgentInvestigator : IAiInvestigator
{
    ...
    public static string SystemPromptText => PromptStore.SystemInvestigator;

    /// <summary>Bias prefix for the fraud-leaning debate agent (research R1).</summary>
    public static string FraudLeaningBias => PromptStore.DebateFraudLeaning;

    /// <summary>Bias prefix for the non-fraud-leaning debate agent (research R1).</summary>
    public static string NonFraudLeaningBias => PromptStore.DebateNonFraudLeaning;

    /// <summary>System prompt for the debate arbiter (research R2).</summary>
    public static string DebateArbiterPrompt => PromptStore.DebateArbiter;

    /// <summary>Prompt extension for the junior agent to include a confidence score (research R3).</summary>
    public static string JuniorConfidenceExtension => PromptStore.JuniorConfidenceExtension;
    ...
    /// </summary>
    public static string SeniorPreambleTemplate => PromptStore.SeniorPreamble;
