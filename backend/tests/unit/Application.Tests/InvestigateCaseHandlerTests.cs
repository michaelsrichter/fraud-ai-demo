...
public class InvestigateCaseHandlerTests
{
    ...
    public async Task HandleAsync_Succeeded_Investigation_Is_Persisted()
    {
        ...
        investigator.Setup(i => i.InvestigateAsync(It.IsAny<Run>(), It.IsAny<Case>(), It.IsAny<string?>(), It.IsAny<float?>(), It.IsAny<bool>(), It.IsAny<CancellationToken>(), It.IsAny<IProgress<ToolInvocation>?>()))
